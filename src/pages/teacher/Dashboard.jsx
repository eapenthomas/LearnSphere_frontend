    ...
    try {
      ...
      for (const course of courses) {
        try {
          ...
          const enrollmentsResponse = await fetch(`${import.meta.env.VITE_API_BASE_URL || 'http://localhost:8000'}/api/enrollments/course/${course.id}`);
      ...
      for (const assignment of assignments) {
        const submissionsResponse = await fetch(`${import.meta.env.VITE_API_BASE_URL || 'http://localhost:8000'}/api/assignments/submissions/${assignment.id}?teacher_id=${user.id}`);
