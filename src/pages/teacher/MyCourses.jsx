...
const TeacherMyCourses = () => {
  ...
  const fetchCoursesFromAPI = async () => {
    try {
      ...
      console.log('Fetching from:', `${API_BASE_URL}/api/courses/teacher/${user.id}`);
  ...
  const handleCreateCourse = async (formData) => {
    try {
      ...
      const response = await fetch('${API_BASE_URL}/api/teacher/create-course', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
  ...
  const handleEditCourse = async (formData) => {
    try {
      ...
      if (formData.thumbnailFile) {
        ...
        const thumbnailResponse = await fetch(`${API_BASE_URL}/api/courses/${selectedCourse.id}/thumbnail`, {
          method: 'PUT',
  ...
  const handleDeleteCourse = async () => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/api/courses/${courseIdToDelete}`, {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
        }
