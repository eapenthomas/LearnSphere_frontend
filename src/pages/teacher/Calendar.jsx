...
const TeacherCalendar = () => {
  ...
  const fetchCalendarData = async () => {
    try {
      ...
      // Fetch quizzes
      const quizzesResponse = await fetch(`${API_BASE_URL}/api/quizzes/teacher/${user.id}`);
      ...
      const analyticsResponse = await fetch(`${API_BASE_URL}/api/teacher/analytics/${user.id}`);
