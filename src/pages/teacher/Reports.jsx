  ...
  const fetchReportData = async () => {
    try {
      ...
      const overviewResponse = await fetch(
        `${API_BASE_URL}/api/teacher/reports/overview?teacher_id=${user.id}&timeframe=${selectedTimeframe}&course_id=${selectedCourse}`
      );
      ...
      if (overviewResponse.ok) {
        ...
        const courseStatsResponse = await fetch(
          `${API_BASE_URL}/api/teacher/reports/course-stats?teacher_id=${user.id}&timeframe=${selectedTimeframe}`
        );
        ...
        const studentPerformanceResponse = await fetch(
          `${API_BASE_URL}/api/teacher/reports/student-performance?teacher_id=${user.id}&course_id=${selectedCourse}`
        );
  ...
  const exportReport = async () => {
    try {
      const response = await fetch(
        `${API_BASE_URL}/api/teacher/reports/export?teacher_id=${user.id}&timeframe=${selectedTimeframe}&course_id=${selectedCourse}`,
        { method: 'POST' }
      );
