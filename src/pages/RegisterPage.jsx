...
const RegisterPage = () => {
  ...
  const handleManualTeacherRegistration = async () => {
    ...
    const response = await fetch('${import.meta.env.VITE_API_BASE_URL || '${import.meta.env.VITE_API_BASE_URL || 'http://localhost:8000'}'}/api/teacher-verification/register-manual', {
      method: 'POST',
      body: formDataToSend,
    });
