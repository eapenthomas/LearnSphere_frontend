...
const AIUsage = () => {
  ...
  const fetchAIUsageData = async () => {
    try {
      ...
      const statsResponse = await fetch('${API_BASE_URL}/api/admin/ai-usage/stats');
      if (statsResponse.ok) {
      ...
      // Fetch recent usage
      const recentResponse = await fetch('${API_BASE_URL}/api/admin/ai-usage/recent?limit=10');
      ...
      const providerResponse = await fetch('${API_BASE_URL}/api/admin/ai-usage/providers');
