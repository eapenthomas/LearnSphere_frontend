  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center page-container">
      <motion.div
        ...
        className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 mobile-grid"
      >
        ...
        <motion.div
          ...
          className="flex flex-col justify-center w-full order-2 lg:order-1"
        >
          {/* Logo and Title */}
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="w-full bg-white hover:bg-gray-50 text-gray-700 font-semibold py-3 px-6 rounded-lg shadow-lg hover:shadow-xl border border-gray-200 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <div className="flex items-center justify-center space-x-2">
