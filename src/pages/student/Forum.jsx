...
const StudentForum = () => {
  ...
  const fetchCourses = async () => {
    try {
      const response = await fetch(`${API_BASE_URL}/api/enrollments/student/${user.id}`);
      if (response.ok) {
  ...
  const handleCreateQuestion = async (e) => {
    ...
    try {
      const response = await fetch(`${API_BASE_URL}/api/forum/questions?student_id=${user.id}`, {
        method: 'POST',
        headers: {
  ...
  const handleResolveQuestion = async (questionId) => {
    try {
      const response = await fetch(`${API_BASE_URL}/api/forum/questions/${questionId}/resolve?student_id=${user.id}`, {
        method: 'PUT',
      });
  ...
  const handleAcceptAnswer = async (answerId) => {
    try {
      const response = await fetch(`${API_BASE_URL}/api/forum/answers/${answerId}/accept?student_id=${user.id}`, {
        method: 'PUT',
      });
