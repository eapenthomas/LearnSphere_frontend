...
const StudentCalendar = () => {
  ...
  const fetchCalendarData = async () => {
    try {
      ...
      const eventsResponse = await fetch(`${import.meta.env.VITE_API_BASE_URL || '${import.meta.env.VITE_API_BASE_URL || 'http://localhost:8000'}'}/api/student/deadlines?${params}`);
      ...
      const upcomingResponse = await fetch(`${import.meta.env.VITE_API_BASE_URL || '${import.meta.env.VITE_API_BASE_URL || 'http://localhost:8000'}'}/api/student/deadlines/upcoming?student_id=${user.id}&limit=7`);
